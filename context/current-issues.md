...
- Canvas nodes from the node panel can be dragged and dropped onto the canvas, but every node show rectangle. Investigate and fix the full drag-and-drop pipeline:
