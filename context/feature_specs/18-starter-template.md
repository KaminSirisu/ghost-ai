...
1. Create `components/editor/start-templates.ts`.
...
2. Create `components/editor/start-templates-modal.tsx`.
...
- Import action replaces the current canvas through the existing code and edge state flow.
