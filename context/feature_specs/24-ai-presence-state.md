...
2. Add a shared AI status feed.
    ...
    - follow Liveblocks best practices for feeds/presence instead of creating parallel reatime state
...
3. Add status message validation
    ...
    - validate incoming message before displaying them
...
## Check When Done
- Sidebar can render shared AI status from `at-status-feed`.
