Add autosave and loading for the collaborative canvas so project state is presisted before adding AI generation Canvas JSON should be stored in Vercel blob, and the saved blob URL should be stored on the Prisma project record.
